            ...
            <div class="widget-header">
                <div class="row">
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                        <h3 class="text-center h2 text-success font-weight-bold">Update DH DETAILS</h3>
                    </div>
                </div>
            </div>
            <div class="widget-content widget-content-area">
                <form class="" action="{{ url('admin/dh-details/'.$dhDetails->id) }}" method="POST" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                    @method('PATCH')
                    <div class="input-group mb-3">
                     ...
                     is-invalid
                    @enderror"
                            name="dh_name" value="{{ $dhDetails->dh_name }}">
                        @error('dh_name')
                    ...
                    <div class="input-group mb-3">
                     ...
                     is-invalid
                    @enderror"
                            name="registered_office" value="{{ $dhDetails->registered_office }}">
                    ...
                    <div class="input-group mb-3">
                     ...
                     is-invalid
                    @enderror"
                            name="present_address" value="{{ $dhDetails->present_address }}">
                    ...
                    <div class="input-group mb-3">
                     ...
                     is-invalid
                    @enderror"
                            name="telephone" value="{{ $dhDetails->telephone }}">
                        @error('telephone')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                        @enderror
                    </div>
                    ...
                    <div class="input-group mb-3">
                     ...
                     is-invalid
                    @enderror"
                            name="email" value="{{ $dhDetails->email }}">
                        @error('email')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                        @enderror
                    </div>
                    <div class="input-group mb-3">
                     ...
                     is-invalid
                    @enderror"
                            name="website" value="{{ $dhDetails->website }}">
                        @error('website')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                        @enderror
                    </div>
                    <div class="input-group mb-3">
                     ...
                     is-invalid
                    @enderror"
                            name="logo" value="{{ $dhDetails->logo }}">
                        @error('logo')
                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                        @enderror
                    </div>
