        ...
        <div class="widget-content widget-content-area ">
            ...
            <div class="row ms-2 me-2">
                <div class="input-group mb-3 col">
                    ...
                    <div class="md-form">
                        <textarea name="buyerAddress"  id="buyerAddress" class="md-textarea form-control">{{ old('buyerAddress') }}</textarea>
                ...
                <div class="input-group mb-3 col">
                    ...
                    <div class="md-form">
                        <textarea name="buyerbankAddress"  id="buyerbankAddress" class="md-textarea form-control">{{ old('buyerbankAddress') }}</textarea>
