                ...
                <div class="card ms-4">
                    <div class="card-body ms-4">
                        ...
                        <div class="table-responsive">
                            <a href="{{ url('manager/supplier-assign-order/create') }}" class="btn btn-success btn-sm"
                                    ...
                                    @foreach ($orders as $order)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ url('manager/supplier-assign-order/' . $order->id) }}"
                                                    class="btn btn-info btn-sm"><i class="fa-solid fa-eye"></i></a>
                                                <a href="{{ url('manager/supplier-assign-order/' . $order->id . '/edit') }}"
