...
class productFormValidation extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'DH_raw_materials'=>'required|string|regex:/^[\pL\s\-]+$/u',
            'supplier_raw_materials'=>'required|string|regex:/^[\pL\s\-]+$/u',
            'wages'=>'required|string|regex:/^[\pL\s\-]+$/u',
            'carring_charge'=>'required|numeric',
            'treatement_deduction'=>'required|string|regex:/^[\pL\s\-]+$/u',
